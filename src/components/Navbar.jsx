...
return (
   <>
      <header className={
        ...
        <nav className='flex items-center justify-between nike-container rtl'>
            ...
            <ul className='flex items-center justify-center gap-2'>
                ...
                <li className='grid items-center'>
                    <button type='button' onClick={onCartToggle} className='border-none outline-none active:scale-110 transition-all duration-300 relative' title="السلة">
