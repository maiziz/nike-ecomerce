  ...
  return (
   <>
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container rtl'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            ...
            <div className='grid items-center absolute top-[33vh] lg:top-[27vh] left-0 gap-3'>
